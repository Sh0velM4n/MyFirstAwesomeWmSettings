...
beautiful.init("/home/shovel/.config/awesome/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    local names = { "Nav", "VScode", "Disc", "4", "5", "6", "7", "8", "9file" }
...
globalkeys = gears.table.join(
    awful.key({ modkey,           }, "s",      hotkeys_popup.szhow_help,
